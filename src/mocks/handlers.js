...
export const handlers = [
  ...
  rest.get(`${baseURL}/api/friends/:userId`, (req, res, ctx) => {
    const { userId } = req.params;
    if (userId === '4f38f403-24b0-42a6-ae40-a8b9637c8789') {
      return res(
        ctx.json({
          friends: [
            {
  ...
  rest.post(`${baseURL}/api/friend-request/:userId`, (req, res, ctx) => {
    const { userId } = req.params;
    if (userId === '4f38f403-24b0-42a6-ae40-a8b9637c8789') {
  ...
  rest.get(`${baseURL}/api/posts/profile/:userId`, (req, res, ctx) => {
    const { userId } = req.params;
    if (userId === '4f38f403-24b0-42a6-ae40-a8b9637c8789') {
      return res(
        ctx.json({
